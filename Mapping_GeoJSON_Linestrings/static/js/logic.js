...
let torontoData = "https://raw.githubusercontent.com/JGarza4903/Mapping_Earthquakes/main/torontoRoutes.json"
...
L.geoJSON(data, {
    ...
    onEachFeature: function(feature,layer) {
        layer.bindPopup("<h3>Airport: "+feature.properties.airline+"</h3><hr><h3> Destination: "+feature.properties.dst+"</h3>");
    }
}).addTo(map);
});
